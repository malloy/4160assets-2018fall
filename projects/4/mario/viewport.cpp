...
void Viewport::update(Uint32 ticks) {
  ...
  if (playerPos[0] > (worldWidth - playerWidth)) {
    playerPos[0] = worldWidth-playerWidth;
  }
  ...
  if (playerPos[1] > (worldHeight - playerHeight)) {
    playerPos[1] = worldHeight-playerHeight;
  }
